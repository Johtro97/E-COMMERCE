      ...
      <div className="p-10 space-y-5 border rounded border-orange-40 bg-white">
        ...
        <form className="flex flex-col justify-center items-center space-y-6">
          <div>
            ...
            <input type="email"placeholder="name@email.com" id="email" name="email"required/>
          </div>
        <textarea className="overflow-y-scroll border rounded w-60 h-36 max-h-36" type="text" placeholder="Write here ..." id="text" name="text" required/>
